...
\hypertarget{md_include_2googletest_2docs_2quickstart-cmake}{}\label{md_include_2googletest_2docs_2quickstart-cmake}\index{Quickstart: Building with CMake@{Quickstart: Building with CMake}}
\label{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md234}%
\Hypertarget{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md234}%
 This tutorial aims to get you up and running with Google\+Test using CMake. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point. If your project uses Bazel, see the \doxysectlink{md_include_2googletest_2docs_2quickstart-bazel}{Quickstart for Bazel}{0} instead.\hypertarget{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md235}{}\doxysection{\texorpdfstring{Prerequisites}{Prerequisites}}\label{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md235}
...
See \doxysectlink{md_include_2googletest_2docs_2platforms}{Supported Platforms}{0} for more information about platforms compatible with Google\+Test.
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md236}{}\doxysection{\texorpdfstring{Set up a project}{Set up a project}}\label{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md236}
...
For more information about how to create {\ttfamily CMake\+Lists.\+txt} files, see the \href{https://cmake.org/cmake/help/latest/guide/tutorial/index.html}{\texttt{ CMake Tutorial}}.\hypertarget{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md237}{}\doxysection{\texorpdfstring{Create and run a binary}{Create and run a binary}}\label{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md237}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md238}{}\doxysection{\texorpdfstring{Next steps}{Next steps}}\label{md_include_2googletest_2docs_2quickstart-cmake_autotoc_md238}

\begin{DoxyItemize}
\item \doxysectlink{md_include_2googletest_2docs_2primer}{Check out the Primer}{0} to start learning how to write simple tests.
\item \doxysectlink{md_include_2googletest_2docs_2samples}{See the code samples}{0} for more examples showing how to use a variety of Google\+Test features. 
\end{DoxyItemize}