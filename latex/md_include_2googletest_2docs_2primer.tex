...
\hypertarget{md_include_2googletest_2docs_2primer}{}\label{md_include_2googletest_2docs_2primer}\index{GoogleTest Primer@{GoogleTest Primer}}
\label{md_include_2googletest_2docs_2primer_autotoc_md220}%
\Hypertarget{md_include_2googletest_2docs_2primer_autotoc_md220}%
 \hypertarget{md_include_2googletest_2docs_2primer_autotoc_md221}{}\doxysection{\texorpdfstring{Introduction\+: Why Google\+Test?}{Introduction\+: Why Google\+Test?}}\label{md_include_2googletest_2docs_2primer_autotoc_md221}
...
Since Google\+Test is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used JUnit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md_include_2googletest_2docs_2primer_autotoc_md222}{}\doxysection{\texorpdfstring{Beware of the Nomenclature}{Beware of the Nomenclature}}\label{md_include_2googletest_2docs_2primer_autotoc_md222}
...
\cellcolor{\tableheadbgcolor}\textbf{ Meaning   }&\cellcolor{\tableheadbgcolor}\textbf{ Google\+Test Term   }&\cellcolor{\tableheadbgcolor}\textbf{ \href{https://www.istqb.org/}{\texttt{ ISTQB}} Term    }\\\cline{1-3}
\endhead
Exercise a particular program path with specific input values and verify the results   &TEST()   &\href{https://glossary.istqb.org/en_US/term/test-case-2}{\texttt{ Test Case}}   \\\cline{1-3}
\end{longtabu}
\hypertarget{md_include_2googletest_2docs_2primer_autotoc_md223}{}\doxysection{\texorpdfstring{Basic Concepts}{Basic Concepts}}\label{md_include_2googletest_2docs_2primer_autotoc_md223}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_include_2googletest_2docs_2primer_autotoc_md224}{}\doxysection{\texorpdfstring{Assertions}{Assertions}}\label{md_include_2googletest_2docs_2primer_autotoc_md224}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \doxysectlink{md_include_2googletest_2docs_2reference_2assertions}{Assertions Reference}{0}.\hypertarget{md_include_2googletest_2docs_2primer_autotoc_md225}{}\doxysection{\texorpdfstring{Simple Tests}{Simple Tests}}\label{md_include_2googletest_2docs_2primer_autotoc_md225}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_include_2googletest_2docs_2primer_same-data-multiple-tests}{}\doxysection{\texorpdfstring{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}}\label{md_include_2googletest_2docs_2primer_same-data-multiple-tests}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_include_2googletest_2docs_2primer_autotoc_md226}{}\doxysection{\texorpdfstring{Invoking the Tests}{Invoking the Tests}}\label{md_include_2googletest_2docs_2primer_autotoc_md226}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_include_2googletest_2docs_2primer_autotoc_md227}{}\doxysection{\texorpdfstring{Writing the main() Function}{Writing the main() Function}}\label{md_include_2googletest_2docs_2primer_autotoc_md227}
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_include_2googletest_2docs_2primer_autotoc_md228}{}\doxysection{\texorpdfstring{Known Limitations}{Known Limitations}}\label{md_include_2googletest_2docs_2primer_autotoc_md228}
