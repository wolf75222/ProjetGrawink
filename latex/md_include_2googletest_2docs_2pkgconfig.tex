...
\hypertarget{md_include_2googletest_2docs_2pkgconfig}{}\label{md_include_2googletest_2docs_2pkgconfig}\index{Using GoogleTest from various build systems@{Using GoogleTest from various build systems}}
\label{md_include_2googletest_2docs_2pkgconfig_autotoc_md215}%
\Hypertarget{md_include_2googletest_2docs_2pkgconfig_autotoc_md215}%
...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md_include_2googletest_2docs_2pkgconfig_autotoc_md216}{}\doxysubsection{\texorpdfstring{CMake}{CMake}}\label{md_include_2googletest_2docs_2pkgconfig_autotoc_md216}
...
pkg-\/config will also try to look in {\ttfamily PKG\+\_\+\+CONFIG\+\_\+\+PATH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md_include_2googletest_2docs_2pkgconfig_autotoc_md218}{}\doxysubsection{\texorpdfstring{Using pkg-\/config in a cross-\/compilation setting}{Using pkg-\/config in a cross-\/compilation setting}}\label{md_include_2googletest_2docs_2pkgconfig_autotoc_md218}
