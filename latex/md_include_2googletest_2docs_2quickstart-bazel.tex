...
\hypertarget{md_include_2googletest_2docs_2quickstart-bazel}{}\label{md_include_2googletest_2docs_2quickstart-bazel}\index{Quickstart: Building with Bazel@{Quickstart: Building with Bazel}}
\label{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md229}%
\Hypertarget{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md229}%
 This tutorial aims to get you up and running with Google\+Test using the Bazel build system. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point.\hypertarget{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md230}{}\doxysection{\texorpdfstring{Prerequisites}{Prerequisites}}\label{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md230}
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md231}{}\doxysection{\texorpdfstring{Set up a Bazel workspace}{Set up a Bazel workspace}}\label{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md231}
...
Now you\textquotesingle{}re ready to build C++ code that uses Google\+Test.\hypertarget{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md232}{}\doxysection{\texorpdfstring{Create and run a binary}{Create and run a binary}}\label{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md232}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md233}{}\doxysection{\texorpdfstring{Next steps}{Next steps}}\label{md_include_2googletest_2docs_2quickstart-bazel_autotoc_md233}
